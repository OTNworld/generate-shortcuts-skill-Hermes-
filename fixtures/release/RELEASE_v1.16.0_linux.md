...
**Mac attestation:** baseline remains **v1.10.0** MATRIX. Deltas in 1.11.0–1.16.0 (palette 13–16, community 17–18, AppIntents `unverified`, Mackasten packages) are **CI/Linux-validated**; device re-attest is tracked in `references/MAC_10_CHECKLIST.md`.
