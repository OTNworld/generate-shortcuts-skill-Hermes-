# Mackasten iOS — requirements (oneshot SSOT)
...
|----|-------------|----------|-------|
| H-F1 | Afficher un catalogue de packages `mackasten-package/v1` | P0 | Seed : 4 packages skill |
...
| H-N4 | Validate JSON Schema `mackasten-package/v1` après fetch | P0 |
...
| H-N11 | Bundle ID `com.otnworld.mackasten` (ajustable au bootstrap) | P0 |
...
- Backend Mackasten cloud custom
