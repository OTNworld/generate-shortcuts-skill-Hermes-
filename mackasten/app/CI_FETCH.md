# CI fetch — skill packages → Mackasten app
...
- `mackasten/packages/*/package.json`
- every `shortcuts[].path` XML referenced by those manifests
- `data/schemas/mackasten-package.v1.json` (for validation)
...
#   Vendor/SkillPackages/schema/mackasten-package.v1.json
```
